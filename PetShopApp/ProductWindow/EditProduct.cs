...
{
    public partial class EditProduct : BaseForm3
    {
        protected override string TitleText => Resources.ResourceManager.GetString("EditProduct_Title") ?? string.Empty;
        protected override string ActionText => Resources.ResourceManager.GetString("EditProduct_Action") ?? string.Empty;
        ...
        {
            Resources.ResourceManager.GetString("EditProduct_Input1") ?? string.Empty,
            Resources.ResourceManager.GetString("EditProduct_Input2") ?? string.Empty,
            Resources.ResourceManager.GetString("EditProduct_Input3") ?? string.Empty,
            Resources.ResourceManager.GetString("EditProduct_Input4") ?? string.Empty,
            Resources.ResourceManager.GetString("EditProduct_Input5") ?? string.Empty
        };
        ...
        protected override void OnActionClicked()
        {
            ...
            {
                MessageBox.Show(Resources.ResourceManager.GetString("EditProduct_Message_FillArticle") ?? string.Empty);
                return;
            }
            if (string.IsNullOrWhiteSpace(name))
            {
                MessageBox.Show(Resources.ResourceManager.GetString("EditProduct_Message_FillName") ?? string.Empty);
                return;
            }
            ...
            {
                MessageBox.Show(Resources.ResourceManager.GetString("EditProduct_Message_InvalidPrice") ?? string.Empty);
                return;
            }
            ...
            Database.ProductRepository.Update(article, name, category, unit, price);
            Close();
        }
    }
}
